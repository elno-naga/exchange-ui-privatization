...
export default [
  // 区域和IP禁止访问 落地页
  {
    ...
    meta: {
      ...
      hideHeader: 'visitLimit', // 访问限制，不显示头部导航
  ...
  {
    path: `${routerEnv}/svgallpage`,
    name: 'svgallpage',
    meta: {
      theme: 'homeOther',
      navigation: '1', // 国际版中使用横向导航
      hideFooter: 'false', // 不隐藏footer
      pageTitle: 'svgallpage',
    },
    component: () => import('@/views/svgallpage.vue'),
  },
  {
    path: `${routerEnv}/allComponents`,
    name: 'allComponents',
    meta: {
      theme: 'homeOther',
      navigation: '1', // 国际版中使用横向导航
      hideFooter: 'false', // 不隐藏footer
      pageTitle: 'allComponents',
    },
    component: () => import('@/views/allComponents.vue'),
  },
  {
    path: `${routerEnv}/myRate`,
    name: 'permyRatesonal',
    meta: {
      hideHeade: true,
    },
    component: () => import('@/views/personal/myRate.vue'),
  },
