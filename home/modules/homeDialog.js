(() => {
  ...
  class HomeDialog {
    ...
    createDialog() {
      ...
      if (this.dialogType === 'text') {
        containerHtml = ` <div>
                        <div class="dialog-frame-head fill-3-bg">
                          <span class="dialog-frame-head-text text-1-cl">${this.titleText}</span>
                        ...
                        <div class="dialog-frame-bottom fill-3-bg" v-if="haveOption">
                          <div
                            class="dialog-frame-options"
                            :class="!haveTwo ? 'dialog-frame-options-oneBtn' : ''"
                          >
                           <button class="common-button closeBtnClass common-button-text main-1-cl towBtn"
                          ...
                          <button class="common-button common-button-solid main-1-bg text-4-cl oneBtn"
                           style="height: 40px; padding-left: 31px; padding-right: 31px; margin-top: 0px;"
      ...
      const html = `<div class="dialog-markAll fill-8-bg"></div>
