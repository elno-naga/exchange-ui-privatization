...
export default {
  ...
  computed: {
    titleText() { return this.$t('personal.dialog.closeAd'); },
    // table相关
    columns() {
      return [
        {
    ...
    otcLinkUrl() {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        obj.url = '';
        obj.type = '1';
      } else if (window.HOSTAPI === 'co' && this.baseData.publicInfo) {
        obj.url = this.$store.state.baseData.publicInfo.url.otcUrl;
        obj.type = '2';
      }
      return obj;
          ...
          dataList.push(
            {
              ...
              time: formatTime(obj.createTime),
              ...
              status: this.stateHand(obj.status),
              operation: [
                {
                  type: 'button',
