      ...
      const bg = {
        normal: {
          color: new window.echarts.graphic.LinearGradient(0, 0, 0, 1, [
            // { offset: 0, color: getHex(colorMap['main-1-bg']) },
            // { offset: 1, color: getHex(colorMap['fill-2-bg']) },
            { offset: 0, color: colorMap['main-4-bg'] },
            { offset: 1, color: colorMap['main-4-bg'] },
          ]),
        },
      };
      this.chartLine.setOption({
