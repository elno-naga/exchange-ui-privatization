  ...
  computed: {
    ...
    columns2() {
      return [
        ...
        // },
        {
          title: this.$t('brokerSystem.commissionTable[7]'),
          key: 'total',
        },
        {
  ...
  methods: {
    ...
    setList1(data) {
      ...
      data.forEach((item, index) => {
        ...
        arr.push({
          ...
          total: fixD(item.amount_total, fix),
        });
      });
      this.dataList = arr;
    },
    ...
    setList2(data) {
      ...
      data.forEach((item, index) => {
        ...
        arr.push({
          id: index,
          time: item.time ? timeFn(new Date(item.time), 'yyyy-MM-dd') : '--', // 时间
          coin: item.coin, // 币种
          // fixD(item.amount_return, fix), // 直推佣金
          // fixD(item.amount_sub, fix), // 子经纪分佣
          total: fixD(item.amount_total, fix), // 累计佣金
          status: this.$t('brokerSystem.commissionTable[6]'),
        });
      });
      this.dataList2 = arr;
    },
