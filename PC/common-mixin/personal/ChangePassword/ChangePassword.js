export default {
    ...
    resetPassword(resetPassword) {
      if (resetPassword !== null) {
        ...
        if (resetPassword.text === 'success') {
          this.$bus.$emit('tip', { text: this.$t('personal.prompt.changePasswordSuccess'), type: 'success' });
  ...
  computed: {
    promptText1() { return this.$t('personal.label.oldPassword'); },
    promptText2() { return this.$t('personal.label.newPassword'); },
    promptText3() { return this.$t('personal.label.newPasswordAgain'); },
    promptText4() { return this.$t('personal.label.smsCodeText'); },
    promptText5() { return this.$t('personal.label.googleCodeText'); },
    errorText1() { return this.$t('personal.prompt.errorPasswordText'); },
    errorText2() { return this.$t('personal.prompt.errorPasswordText'); },
    errorText3() { return this.$t('personal.prompt.errorPasswordTwo'); },
    ...
    out() {
      this.axios({
        ...
        if (data.code.toString() === '0') {
          // this.$bus.$emit('tip', { text: this.$t('personal.prompt.changePasswordSuccess') || data.msg, type: 'success' });
          this.$bus.$emit('outUserIsLogin');
        } else {
          // this.$bus.$emit('tip', { text: this.$t('personal.prompt.changePasswordSuccess') || data.msg, type: 'error' });
        }
      });
    },
    getCodeClick() {
