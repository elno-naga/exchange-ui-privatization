export default {
  ...
  computed: {
    promptText1() { return this.$t('personal.label.oldEmail'); },
    promptText2() { return this.$t('personal.label.newEmail'); },
    promptText3() { return this.$t('personal.label.emailCodeText'); },
    promptText6() { return this.$t('personal.label.newEmailCodeText'); },
    promptText4() { return this.$t('personal.label.smsCodeText'); },
    promptText5() { return this.$t('personal.label.googleCodeText'); },
    // errorText2() { return this.$t('personal.prompt.errorEmailText'); },
    errorText3() { return this.$t('personal.prompt.errorCode'); },
    errorText6() { return this.$t('personal.prompt.errorCode'); },
  ...
  methods: {
    init() {
      this.errorText2 = this.$t('personal.prompt.errorEmailText');
      if (this.userInfo) {
    ...
    getCodeClick(name) {
      ...
      } else if (this.emailFlag(this.checkValue2)) {
