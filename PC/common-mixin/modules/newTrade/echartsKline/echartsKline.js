import {
  colorMap, myStorage, getHex, getIconPath,
} from '@/utils';
...
export default {
  ...
  data() {
    return {
      ...
      tootipData: [],
      ishoverFla: false,
      markPointBgColor: colorMap['fall-1-cl'],
  ...
  methods: {
    ...
    eachart(notData) {
      ...
      if (this.data[len][0] <= this.data[len][1]) {
        this.markPointBgColor = colorMap['rise-1-cl'];
      } else {
        this.markPointBgColor = colorMap['fall-1-cl'];
      }
      this.myEchartsKline.resize();
    ...
    initEachart() {
      ...
      const KlineOption = {
        ...
        axisPointer: {
          link: { xAxisIndex: 'all' },
          label: {
            backgroundColor: colorMap['text-3-bd'],
          },
        },
        dataZoom: [
          {
        ...
        xAxis: [
          {
            ...
            axisLine: { lineStyle: { color: colorMap['text-3-bd'] } },
            axisPointer: {
              label: {
                show: false,
              },
        ...
        series: [
          {
            ...
            itemStyle: {
              color: colorMap['rise-1-cl'],
              color0: colorMap['fall-1-cl'],
              borderColor: colorMap['rise-1-cl'],
              borderColor0: colorMap['fall-1-cl'],
            },
            markPoint: {
              data: [
                {
        ...
        KlineOption.series = [
          {
            ...
            lineStyle: {
              width: 1,
              color: colorMap['main-1-bd'],
            },
            areaStyle: {
              color: new window.echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                offset: 0,
                color: getHex(colorMap['main-1-bd']),

              }, {
                offset: 1,
                color: colorMap['main-4-bg'],
              }]),
            },
          },
          {
