...
*****************************
<template>
  <section class='common-getCode' :class='className' :style="lineStyle">
    <!-- 获取验证码 -->
    <c-v6-button
      type='text'
      height='30px'
      ...
      :name='buttonName'
      :disabled="disabled"
      >{{ $t('components.getCode.button') }}</c-v6-button
    >
    <!-- 后重新获取 -->
    <div class='times text-2-cl' v-else>
...
export default {
  ...
  props: {
    ...
    lineStyle: { type: [Object, String], default: '' }, // 样式
