      ...
      <vue-scroll :ops="xScrollOps">
        <div :class="['table-scroll-wrap', classBox]">
          ...
          <vue-scroll @handle-scroll="tableBodyScroll" ref="bodyScroll">
            ...
            >
              <div class="table-body-bar text-1-cl" :style="bodyBarStyle">
                        ...
                        <div class="tr-content">
                          ...
                          >
                            <div
                              ...
                              :key="m.key + n"
                            >
                              <c-skeleton v-if="loading"></c-skeleton>
                          ...
                          >
                            <slot name="subContent" :row="item">
                              <c-skeleton height="200px" v-if="subLoading"></c-skeleton>
                              <div class="sub-table-wrap" v-else>
...
export default {
  ...
  computed: {
    ...
    bodyBarStyle() {
      if (this.bodyHeight) {
        return { minHeight: `${this.bodyHeight}px` };
      }
      return null;
    },
    emptyHeight() {
  ...
  methods: {
    ...
    getSortValue(item) {
      if (parseFloat(item[this.sorteKey]) && item[this.sorteKey].indexOf(',') > 0) {
        return parseFloat(item[this.sorteKey].replace(',', ''));
      }
