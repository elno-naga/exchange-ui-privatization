...
<template>
  <!--  -->
  <button
      class="common-button common-button common-button-v6"
      :style="contentStyle"
...
export default {
  ...
  computed: {
    theme() {
      return getCookie('cusSkin') || getCookie('defSkin') || '1';
    },
    contentStyle() {
      ...
      switch (this.type) {
        ...
        case 'solid':
          ...
          paddingW = paddingW === '' ? '16px' : paddingW;
          break;
          // 空心
        case 'hollow':
    ...
    defaultColor() {
      ...
      const colorTypes = {
        primary: {
          ...
          'solid-loading': 'main-1-bg text-4-cl',
          hollow: 'main-5-cl main-5-bd',
          text: 'main-5-cl',
        },
        config: {
    ...
    hoverColor() {
      ...
      const colorTypes = {
        primary: {
          ...
          'solid-loading': 'main-2-bg text-4-cl',
    ...
    activeColor() {
      ...
      const colorTypes = {
        primary: {
          ...
          'solid-loading': 'main-3-bg text-4-cl',
...
.common-button {
  ...
  // 文本按钮
  &.common-button-text .common-button-slot,
  &.common-button-text-kind .common-button-slot {
    font-size: 14px;
    line-height: 16px;
  }
